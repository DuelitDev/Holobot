...
RUN wget https://github.com/DuelitDev/Holobot/archive/refs/tags/v2.4.1.230331.8.tar.gz && \
    tar xf v2.4.1.230331.8.tar.gz && mv Holobot-2.4.1.230331.8 holobot && \
    rm v2.4.1.230331.8.tar.gz
