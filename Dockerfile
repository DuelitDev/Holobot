...
RUN apt-get update && apt-get install -y nano wget python3.11 python3-pip libopus-dev && \
    wget https://github.com/DuelitDev/Holobot/archive/refs/tags/v2.4.1.230331.2.tar.gz && \
    tar xf v2.4.1.230331.2.tar.gz && mv Holobot-2.4.1.230331.2 holobot && \
    rm v2.4.1.230331.2.tar.gz && pip install -r /holobot/requirements.txt
